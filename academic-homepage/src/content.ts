...
export const siteContent: SiteContent = {
  ...
  education: [
    { institution: { zh: "浙江大学", en: "Zhejiang University" }, school: { zh: "软件学院", en: "School of Software Technology" }, degree: { zh: "软件工程 · 硕士", en: "MSc in Software Engineering" }, period: "2026.09-2029.06", details: [{ zh: "2026 级硕士研究生", en: "2026 Cohort" }] },
    { institution: { zh: "武汉大学", en: "Wuhan University" }, school: { zh: "国家网络安全学院", en: "School of Cyber Science and Engineering" }, degree: { zh: "网络空间安全 · 本科", en: "BSc in Cyberspace Security" }, period: "2022.09-2026.06", details: [{ zh: "毕业论文：《车载网络安全加密技术验证与测试》", en: "Thesis: Verification and Testing of Encryption for In-Vehicle Networks" }, { zh: "国家级大学生创新训练项目", en: "National Undergraduate Innovation Training Program" }] }
  ],
  skills: [
